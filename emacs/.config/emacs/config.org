...
#+begin_src emacs-lisp
  ...
  (setq raku-exec-path "/home/anon/.local/bin/raku")
#+end_src
*** HTML & CSS offset
#+begin_src emacs-lisp
...
#+begin_src emacs-lisp
  ...
  (add-hook 'org-mode-hook 'reimu/no-lines) 
...
simple.
#+BEGIN_SRC emacs-lisp
  (global-set-key (kbd "M-d") 'reimu/kill-inner-word)
  (global-set-key (kbd "M-.") 'repeat)
  (global-set-key (kbd "C-x k") 'kill-buffer)
  (global-set-key (kbd "C-x C-k") 'kill-current-buffer)
  (global-unset-key (kbd "C-x C-b"))
  (global-set-key (kbd "C-x C-b") 'reimu/goto-previous-buffer)
#+END_SRC
** Hunspell
...
#+begin_src emacs-lisp
  ...
  (defun reimu/mark-words-between-quotes ()
       "Does that."
       (interactive)
       (er/expand-region 2))

  (global-set-key (kbd "C-c q") 'reimu/mark-words-between-quotes)
#+end_src
** Beacon mode
#+begin_src emacs-lisp
  (use-package beacon
...
#+begin_src emacs-lisp
  ...
  (add-hook 'Man-mode-hook 'reimu/no-lines)
  (add-hook 'speedbar-mode-hook 'reimu/no-lines)
#+end_src
** Hungry delete
...
#+begin_src emacs-lisp
  (global-set-key (kbd "C-c C-d") 'reimu/goto-dashboard)
#+end_src
...
(use-package base16-theme
  :ensure t
  :init(load-theme 'base16-heetch t))
